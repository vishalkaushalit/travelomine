                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.call-log.export', request()->query()) }}" class="btn btn-success btn-sm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select name="follow_up" class="form-control">
                                        ...
                                        <option value="1" {{ request('follow_up') == '1' ? 'selected' : '' }}>Follow Up
                                            Required</option>
                                        <option value="0" {{ request('follow_up') == '0' ? 'selected' : '' }}>No Follow
                                            Up</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
