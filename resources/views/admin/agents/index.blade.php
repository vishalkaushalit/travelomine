                        ...
                        <tbody>
                            @foreach ($agents as $agent)
                                <tr>
                                    ...
                                    <td>{{ $agent->name }} <br> <span
                                            class="badge badge-sm small badge-info bg-info ">{{ $agent->alias_name }}</span>
                                    </td>
                                    <td>{{ $agent->email }}</td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                {{ $agent->is_active ? 'deactivate' : 'activate' }} this
                                                agent?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Cancel</button>
                                                <form action="{{ route('admin.agents.toggleStatus', $agent->id) }}"
