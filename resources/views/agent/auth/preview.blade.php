...
<body>
    <div class="page-shell">
        <div class="top-bar">
            <div class="top-bar-inner">
                ...
                <div class="top-bar-actions">
                    <!-- CHANGE THIS: Updated back to editor route for agent -->
                    <a href="{{ route('agent.authorize.edit', $booking->id) }}" class="btn btn-sm btn-outline-primary">
                        ← Back to Editor
                    </a>
                </div>
            </div>
        ...
        <div class="page-actions">
            <!-- CHANGE THIS: Updated send route for agent -->
            <form action="{{ route('agent.authorize.send', $booking->id) }}" method="POST">
                @csrf
