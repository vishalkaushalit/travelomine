...
@section('content')
                        ...
                        <div class="row g-4">
                            <div class="col-6 col-sm-3">
                                <div class="info-item mb-3">
                                    <span class="text-muted small">Agent Name</span>
                                    <span class="fw-semibold d-block">
                                        {{ $profileData['name'] }}({{ $profileData['alias_name'] }})
                                    </span>
                                </div>
                            </div>
                            <div class="col-6 col-sm-3">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm h-100 mco_chart">
                    ...
                    @else
                        <div class="booking-list">
                            @foreach ($recentBookings as $index => $booking)
                                <div
                                    class="booking-item p-3 {{ $index < count($recentBookings) - 1 ? 'border-bottom' : '' }}">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="route-info">
                                            ...
                                            <small class="text-muted">
                                                {{ $booking->departure_city ?? 'N/A' }} →
                                                {{ $booking->arrival_city ?? 'N/A' }}
                                            </small>
                                        </div>
                                        <div class="text-end">
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <i
                                                class="bi bi-clock me-1"></i>{{ optional($booking->created_at)->format('d M Y H:i') }}
                                        </small>
                                    </div>
                                </div>
                            @endforeach
