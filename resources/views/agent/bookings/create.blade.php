...
@section('content')
    <div class="container-fluid py-4">
        ...
        <form action="{{ route('agent.bookings.store') }}" method="POST" id="bookingForm">
            ...
            <div class="card mb-4">
                <div class="card-header"><strong>7. Payment Details</strong></div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="payment_card_details">Payment Details</label>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="agent_remarks">Agent Remark</label>
                        <p class="text-muted small">Enter remarks here </p>
                        <textarea placeholder="Message" name="agent_remarks" class="form-control" rows="4" id="agent_remarks"
                            required>{{ old('agent_remarks') }}</textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close pnr-modal-close" data-bs-dismiss="modal"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function searchBookingByPnr() {
                ...
                try {
                    ...
                    const paymentFields = ['currency', 'amount_charged', 'amount_paid_airline', 'total_mco',
                    ...
                    showMessage('warning', 'No existing booking found for PNR: ' + pnr +
                        '. You can manually enter all details for this new booking. The selected service type "' +
                        selectedServiceType + '" has been kept.');
