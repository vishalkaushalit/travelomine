...
<head>
    ...
    <title>Customer Support Service | Travelomile Flights Unlocked</title>
                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
                            ...
                            <a href="{{ route('support.profile.index') }}" class="dropdown-item">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('support.dashboard') }}"
                                    class="nav-link {{ request()->routeIs('support.dashboard') ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('support.bookings.all') }}"
                                            class="nav-link {{ request()->routeIs('support.bookings.all') ? 'active' : '' }}">
