        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                @auth
                    ...
                    <li class="nav-item">
                        <a href="{{ route('charge.dashboard') }}"
                            class="nav-link {{ request()->routeIs('charging.dashboard') ? 'active' : '' }}">
                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
                            ...
                            <a href="{{ route('charge.profile.index') }}" class="dropdown-item">
                ...
                @auth
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('charge.dashboard') }}"
                                    class="nav-link {{ request()->routeIs('charge.dashboard') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-tachometer-alt"></i>
                                    <p>Dashboard</p>
                                </a>
                            </li>
                            ...
                            <!-- Notifications -->
                            <li class="nav-item">
                                <a href="{{ route('charge.notifications') }}"
                                    class="nav-link {{ request()->routeIs('charge.notifications') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-bell"></i>
                                    <p>Notifications</p>
                                </a>
                            </li>
