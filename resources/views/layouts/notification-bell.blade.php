...
<div class="position-fixed bottom-0 end-0 me-3 mb-3" style="z-index: 1050;">
    {{-- Bell button --}}
<<<<<<< HEAD
    <button id="notifyBell" class="btn btn-lg btn-outline-light rounded-circle p-2" data-bs-toggle="modal"
        data-bs-target="#notifyModal" aria-label="Notifications">
...
@push('scripts')
    <script>
        ...
        async function updateNotifyBadge() {
            try {
                const resp = await fetch('{{ route('notifications.count') }}', {
