...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Small icons spacing */
        .sidebar .nav-link i, .sidebar .dropdown-toggle-link i {
            margin-right: 10px;
            width: 22px;
            text-align: center;
        }
...
<body>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ($.fn.dataTable) {
                $.fn.dataTable.defaults.lengthMenu = [[10, 25, 50, -1], [10, 25, 50, "All"]];
            }
        });
    </script>
    ...
    <style>
        ...
        .sidebar .nav-link i.bi, .sidebar .dropdown-toggle-link i.bi {
            font-size: 1.1rem;
        ...
        /* Additional active link precision */
        .sidebar a.nav-link.active i, 
        .sidebar .dropdown-toggle-link.active i {
            color: #74b9ff;
        }
