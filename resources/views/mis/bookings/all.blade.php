                        ...
                        <tbody>
                            @forelse($bookings as $booking)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('mis.bookings.index', ['agent_id' => $booking->user_id]) }}"
                                    ...
                                    <td>
                                        @if ($booking->segments->count() > 0)
                                            ...
                                            @if ($booking->segments->count() > 2)
                                                <small class="text-muted">+{{ $booking->segments->count() - 2 }}
                                                    more</small>
                                            @endif
                                        @else
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span
                                                class="badge bg-teal">{{ ucwords(str_replace('_', ' ', $booking->status)) }}</span>
                                        @endif
                                    </td>
                                    <td>
