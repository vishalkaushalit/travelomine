...
@section('title', 'All Bookings - MIS')
...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('mis.bookings.all') }}" class="row g-3" id="filterForm">
                    <!-- Search -->
                    <div class="col-md-3">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form id="exportForm" method="POST" action="{{ route('mis.bookings.export.selected') }}">
                    @csrf
                    ...
                    <table class="table table-bordered table-striped align-middle">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th>
                                    <a href="{{ route('mis.bookings.all', array_merge(request()->all(), ['sort' => 'id', 'direction' => request('sort') == 'id' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}" 
                                ...
                                <th>
                                    <a href="{{ route('mis.bookings.all', array_merge(request()->all(), ['sort' => 'customer_name', 'direction' => request('sort') == 'customer_name' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}" 
                                       class="text-white text-decoration-none">
                                        Agent / Customer
                                ...
                                <th>
                                    <a href="{{ route('mis.bookings.all', array_merge(request()->all(), ['sort' => 'booking_date', 'direction' => request('sort') == 'booking_date' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}" 
                                       class="text-white text-decoration-none">
                                        Booking Date
                                ...
                                <th>PAX</th>
                                <th>
                                    <a href="{{ route('mis.bookings.all', array_merge(request()->all(), ['sort' => 'amount_charged', 'direction' => request('sort') == 'amount_charged' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}" 
                                       class="text-white text-decoration-none">
                                        Amount
                                ...
                                <th>MCO</th>
                                <th>
                                    <a href="{{ route('mis.bookings.all', array_merge(request()->all(), ['sort' => 'status', 'direction' => request('sort') == 'status' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}" 
                                       class="text-white text-decoration-none">
                                        Status
    ...
    <script>
        ...
        function exportSelected() {
            ...
            document.getElementById('exportForm').action = '{{ route('mis.bookings.export.selected') }}';
        ...
        function exportAll() {
            ...
            form.action = '{{ route('mis.bookings.export.all') }}';
