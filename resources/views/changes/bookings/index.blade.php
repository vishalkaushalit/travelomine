...
@section('title', 'Changes Bookings')
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                            ...
                            Bookings for Changes: {{ $agent->name ?? 'N/A' }}
                    ...
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($bookings as $booking)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-info">{{ $booking->booking_reference ?? 'N/A' }}</span>
                                                    <br>
                        ...
                        <div class="mt-3">
                            <a href="{{ route('changes.agents.index') }}" class="btn btn-secondary">
                                <i class="bi bi-arrow-left"></i> Back to Changes
                            </a>
                        </div>
                    </div>
                </div>
