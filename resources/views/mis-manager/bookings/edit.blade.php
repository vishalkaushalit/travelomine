            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        @error('call_type')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>

                    <div class="col-md-3 mb-3">
                        <label class="form-label">Service Provided <span class="text-danger">*</span></label>
                        <select name="service_provided" id="service_provided" class="form-control @error('service_provided') is-invalid @enderror" required>
                        ...
                        @error('service_provided')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="booking_portal" class="form-control @error('booking_portal') is-invalid @enderror" required>
                        ...
                        @error('booking_portal')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="language" class="form-control @error('language') is-invalid @enderror" required>
                            ...
                            <option value="English-Flight" {{ old('language', $booking->language ?? '') == 'English-Flight' ? 'selected' : '' }}>
                                English</option>
                            <option value="Spanish-Flight" {{ old('language', $booking->language ?? '') == 'Spanish-Flight' ? 'selected' : '' }}>
                                Spanish</option>
                        </select>
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="email_auth_taken"
                                name="email_auth_taken" value="1" {{ old('email_auth_taken', $booking->email_auth_taken) ? 'checked' : '' }}>
                ...
                <div class="row flight-row">
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="flight_type" id="flight_type" class="form-control">
                            ...
                            <option value="oneway" {{ old('flight_type', $booking->flight_type ?? '') == 'oneway' ? 'selected' : '' }}>One Way
                            </option>
                            <option value="roundtrip" {{ old('flight_type', $booking->flight_type ?? '') == 'roundtrip' ? 'selected' : '' }}>Round
                                Trip</option>
                            <option value="multicity" {{ old('flight_type', $booking->flight_type ?? '') == 'multicity' ? 'selected' : '' }}>Multi
                                City</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="gk_pnr" class="form-control" value="{{ old('gk_pnr', $booking->gk_pnr ?? '') }}">
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" min="0" max="9" class="form-control passenger-counter"
                            id="children_count" name="children" value="{{ old('children', $booking->children ?? 0) }}">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" min="0" max="9" class="form-control passenger-counter"
                            id="infant_in_lap_count" name="infant_in_lap" value="{{ old('infant_in_lap', $booking->infant_in_lap ?? 0) }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" min="0" name="amount_charged"
                            id="amount_charged" class="form-control" value="{{ old('amount_charged', $booking->amount_charged ?? '') }}" required>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" min="0" name="amount_paid_airline"
                            id="amount_paid_airline" class="form-control" value="{{ old('amount_paid_airline', $booking->amount_paid_airline ?? '') }}"
                            required>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" name="total_mco" id="total_mco" class="form-control bg-light"
                            value="{{ old('total_mco', $booking->total_mco ?? '') }}" readonly>
                        ...
                        <div class="row">
                                ...
                                <select name="full_payment[agency_merchant_id]" id="full_payment_agency_merchant_id"
                                    ...
                                    @foreach ($merchants as $merchant)
                                        <option value="{{ $merchant->id }}"
                                            {{ old('full_payment.agency_merchant_id', $booking->full_payment->agency_merchant_id ?? '') == $merchant->id ? 'selected' : '' }}>
                                            {{ $merchant->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3 col-lg-2">
                                ...
                                <input type="number" step="0.01" min="0"
                                    ...
                                    class="form-control payment-full-field"
                                    value="{{ old('full_payment.charge_amount', $booking->full_payment->charge_amount ?? '') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3 col-lg-4">
                                ...
                                <input type="text" name="full_payment[card_holder_name]"
                                    class="form-control payment-full-field"
                                    value="{{ old('full_payment.card_holder_name', $booking->full_payment->card_holder_name ?? '') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3 col-lg-2">
                                ...
                                <input type="text" name="full_payment[card_last_four]"
                                    ...
                                    value="{{ old('full_payment.card_last_four', $booking->full_payment->card_last_four ?? '') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 col-lg-3">
                                ...
                                <input type="text" name="split_payment[airline_merchant_name]"
                                    ...
                                    value="{{ old('split_payment.airline_merchant_name', $booking->split_payment->airline_merchant_name ?? '') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3 col-lg-3">
                                ...
                                <input type="number" step="0.01" min="0"
                                    ...
                                    class="form-control payment-split-field"
                                    value="{{ old('split_payment.airline.charge_amount', $booking->split_payment->airline_charge_amount ?? '') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3 col-lg-4">
                                ...
                                <input type="text" name="split_payment[airline][card_holder_name]"
                                    class="form-control payment-split-field"
                                    value="{{ old('split_payment.airline.card_holder_name', $booking->split_payment->airline_card_holder_name ?? '') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3 col-lg-2">
                                ...
                                <input type="text" name="split_payment[airline][card_last_four]"
                                    ...
                                    value="{{ old('split_payment.airline.card_last_four', $booking->split_payment->airline_card_last_four ?? '') }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 col-lg-3">
                                ...
                                <select name="split_payment[agency][agency_merchant_id]"
                                    ...
                                    @foreach ($merchants as $merchant)
                                        <option value="{{ $merchant->id }}"
                                            {{ old('split_payment.agency.agency_merchant_id', $booking->split_payment->agency_merchant_id ?? '') == $merchant->id ? 'selected' : '' }}>
                                            {{ $merchant->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="hotel_required"
                                name="hotel_required" value="1" {{ old('hotel_required', $booking->hotel_required) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="cab_required"
                                name="cab_required" value="1" {{ old('cab_required', $booking->cab_required) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="insurance_required"
                                name="insurance_required" value="1" {{ old('insurance_required', $booking->insurance_required) ? 'checked' : '' }}>
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-12 mb-3">
                        ...
                        <select name="status" class="form-control @error('status') is-invalid @enderror" required>
                            ...
                            <option value="pending" @if(old('status', $booking->status) === 'pending') selected
                                @endif>Pending</option>
                            <option value="assigned_to_charging" @if(old('status', $booking->status) ===
                                'assigned_to_charging') selected @endif>Assigned to Charging</option>
                            <option value="auth_email_sent" @if(old('status', $booking->status) === 'auth_email_sent')
                                selected @endif>Auth Email Sent</option>
                            <option value="payment_processing" @if(old('status', $booking->status) ===
                                'payment_processing') selected @endif>Payment Processing</option>
                            <option value="failed" @if(old('status', $booking->status) === 'failed') selected
                                @endif>Failed</option>
                            <option value="cancelled" @if(old('status', $booking->status) === 'cancelled') selected
                                @endif>Cancelled</option>
                            <option value="hold" @if(old('status', $booking->status) === 'hold') selected @endif>Hold
                            </option>
                            <option value="refund" @if(old('status', $booking->status) === 'refund') selected
                                @endif>Refund</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="agent_remarks" class="form-control @error('agent_remarks') is-invalid @enderror"
                            rows="2"
                            placeholder="Enter agent remarks...">{{ old('agent_remarks', $booking->agent_remarks) }}</textarea>
                        @error('agent_remarks')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="form-label">Charging Remarks</label>
                        <textarea name="charging_remarks"
                            class="form-control @error('charging_remarks') is-invalid @enderror" rows="2"
                            placeholder="Enter charging remarks...">{{ old('charging_remarks', $booking->charging_remarks) }}</textarea>
                        @error('charging_remarks')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="form-label">MIS Remarks</label>
                        <textarea name="mis_remarks" class="form-control @error('mis_remarks') is-invalid @enderror"
                            rows="2"
                            placeholder="Enter MIS remarks...">{{ old('mis_remarks', $booking->mis_remarks) }}</textarea>
                        @error('mis_remarks')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <textarea name="manager_remark" class="form-control @error('manager_remark') is-invalid @enderror"
                        rows="4" placeholder="Please explain why you're making this change..." id="manager_remark"
                        required>{{ old('manager_remark', $booking->manager_remark ?? '') }}</textarea>
                    @error('manager_remark')<span class="invalid-feedback">{{ $message }}</span>@enderror
                </div>
            </div>
        </div>
