<h3>Autorización para {{ $booking->segments->first()?->airline_name ?? 'la aerolínea' }} Confirmación de Cambio/Mejora.
    </h3>
    <p>Estimado/a {{ $booking->customer_name ?? 'Pasajero/a' }},</p>
    <p>¡Saludos cordiales!</p>
    <p>Según nuestra conversación y según lo acordado, hemos realizado su cambio/mejora con
