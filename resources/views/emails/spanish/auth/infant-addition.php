    <h3>Authorization for {{ $booking->segments->first()?->airline_name ?? 'the airline' }} Infant Addition Confirmation.
    </h3>

    <p>Dear {{ $booking->customer_name ?? 'Passeneger' }},</p>
    <p>Greetings of the day !!</p>
    <p>As per our conversation and as agreed, we have booked your infant addition with
