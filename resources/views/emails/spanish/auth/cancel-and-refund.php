<h3>Autorización para {{ $booking->segments->first()?->airline_name ?? 'la aerolínea' }} Confirmación de Cancelación y Reembolso.
    </h3>

    <p>Estimado/a {{ $booking->customer_name ?? 'Pasajero/a' }},</p>
    <p>¡Saludos cordiales!</p>
    <p>Según nuestra conversación y según lo acordado, hemos procesado la cancelación y el reembolso de su reserva con
    ...
    <p>
        Por favor, confirme su aceptación de los términos y acuerdo a la declaración respondiendo a este correo electrónico con
        'Acepto' o 'Autorizo'.
    </p>
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 16px 0; background-color: #f9fafb;">
        <tbody>
            <tr style="border-bottom: 1px solid #e5e7eb;">
                <td style="padding: 12px 16px; font-weight: 600; background-color: #f3f4f6; width: 40%;">Nombre del Titular de la Tarjeta:
                </td>
